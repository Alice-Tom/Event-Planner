...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
	...
	<header class="top-header">
		<nav class="navbar header-nav navbar-expand-lg">
            <div class="container">
				<a class="navbar-brand" href="index.html"><img src="images/i1.png" alt="image"></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="#story">Our Services</a></li>
					...
					<div class="pogoSlider-slide" data-transition="blocksReveal" data-duration="1500" style="background-image:url(images/slider-02.jpg);">
						<div class="lbox-caption">
							...
							<h1>The Event Planner</h1>
								...
								<p><strong>We make thinngs happen</strong></p>
								<a href="#" class="btn ">Contact</a>
							</div>
						</div>
					</div>
